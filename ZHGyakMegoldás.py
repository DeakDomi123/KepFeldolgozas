...
#Képjavítók, korrekciók: világosság, szűrők pl boxfilter median, életítés, kontrasztkiegenylítés (színes képnél a 3d-s tömbből csinálok egy 3db 2d-set)

def Elso():
    img = cv2.imread(".\\Kepek\\rozsa.jpg",1)
    ...
    formatParameters_jpg.insert(92)
    cv2.imwrite("result.jpg", result, formatParameters_jpg)
